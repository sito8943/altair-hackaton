...
const educationOptions = ['High school / GED', 'Associate degree', "Bachelor's", "Master's", 'Doctorate']
const employmentOptions = ['Employed', 'Self-employed', 'Unemployed', 'Retired', 'Student', 'Caregiver']
const maritalOptions = ['Single', 'Married', 'Partnered', 'Divorced', 'Widowed']
        ...
        <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
          ...
          <Box sx={{ flex: '1 1 260px', minWidth: { xs: '100%', sm: 260 } }}>
            <Autocomplete
              ...
              onChange={(_, newValue) => onChange('education_level', newValue ?? '')}
              renderInput={(params) => (
                <TextField
                  {...params}
          ...
          <Box sx={{ flex: '1 1 260px', minWidth: { xs: '100%', sm: 260 } }}>
            <Autocomplete
              ...
              onChange={(_, newValue) => onChange('employment_status', newValue ?? '')}
              renderInput={(params) => (
                <TextField
                  {...params}
          ...
          <Box sx={{ flex: '1 1 260px', minWidth: { xs: '100%', sm: 260 } }}>
            <Autocomplete
              ...
              onChange={(_, newValue) => onChange('marital_status', newValue ?? '')}
              renderInput={(params) => (
                <TextField
                  {...params}
